...
#ifndef AI_INFRA_FUSED_INFER_ATTENTION_SINK_METADATA_AICPU_H
#define AI_INFRA_FUSED_INFER_ATTENTION_SINK_METADATA_AICPU_H
...
class AiInfraFusedInferAttentionSinkMetadataKernel : public CpuKernel {
  public:
    AiInfraFusedInferAttentionSinkMetadataKernel() = default;
    ~AiInfraFusedInferAttentionSinkMetadataKernel() noexcept = default;
...
#endif // AI_INFRA_FUSED_INFER_ATTENTION_SINK_METADATA_AICPU_H