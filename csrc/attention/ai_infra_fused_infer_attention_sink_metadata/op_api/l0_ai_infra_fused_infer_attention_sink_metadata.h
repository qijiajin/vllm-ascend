...
#ifndef L0_AI_INFRA_FUSED_INFER_ATTENTION_SINK_METADATA_AICPU_H
#define L0_AI_INFRA_FUSED_INFER_ATTENTION_SINK_METADATA_AICPU_H

#include "opdev/op_executor.h"

namespace AiInfraFusedInferAttentionSinkMetadatal0op {
const aclTensor* AiInfraFusedInferAttentionSinkMetadata(
