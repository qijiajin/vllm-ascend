...
/*!
 * \file aclnn_ai_infra_fused_infer_attention_sink_metadata.cpp
 * \brief
 */

#include "aclnn_ai_infra_fused_infer_attention_sink_metadata.h"
#include "l0_ai_infra_fused_infer_attention_sink_metadata.h"
...
aclnnStatus aclnnAiInfraFusedInferAttentionSinkMetadataGetWorkspaceSize(const aclTensor *actualSeqLengthsOptional,
                                                                        const aclTensor *actualSeqLengthsKvOptional,
                                                                        int64_t numHeadsQ,
                                                                        int64_t numHeadsKv,
                                                                        int64_t headDimQk,
...
{
    L2_DFX_PHASE_1(aclnnAiInfraFusedInferAttentionSinkMetadata,
    ...
    auto output = AiInfraFusedInferAttentionSinkMetadatal0op::AiInfraFusedInferAttentionSinkMetadata(
...
__attribute__((visibility("default"))) aclnnStatus aclnnAiInfraFusedInferAttentionSinkMetadata(void *workspace,
                                                                                               uint64_t workspaceSize,
                                                                                               aclOpExecutor *executor,
                                                                                               aclrtStream stream)
{
    L2_DFX_PHASE_2(aclnnAiInfraFusedInferAttentionSinkMetadata);
