...
/*!
 * \file l0_ai_infra_fused_infer_attention_sink_metadata.cpp
 * \brief
 */
...
using namespace op;
namespace AiInfraFusedInferAttentionSinkMetadatal0op {
OP_TYPE_REGISTER(AiInfraFusedInferAttentionSinkMetadata);

const aclTensor *AiInfraFusedInferAttentionSinkMetadata(const aclTensor *actualSeqLengthsOptional,
...
{
    L0_DFX(AiInfraFusedInferAttentionSinkMetadata,
