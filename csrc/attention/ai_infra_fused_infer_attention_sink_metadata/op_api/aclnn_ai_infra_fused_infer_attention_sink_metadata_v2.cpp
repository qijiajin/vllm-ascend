...
/*!
 * \file aclnn_ai_infra_fused_infer_attention_sink_metadata_v2.cpp
 * \brief
 */

#include "aclnn_ai_infra_fused_infer_attention_sink_metadata_v2.h"
...
aclnnStatus aclnnAiInfraFusedInferAttentionSinkMetadataV2GetWorkspaceSize(const aclTensor *actualSeqLengthsOptional,
                                                                          const aclTensor *actualSeqLengthsKvOptional,
                                                                          int64_t numHeadsQ,
                                                                          int64_t numHeadsKv,
                                                                          int64_t headDimQk,
...
{
    L2_DFX_PHASE_1(aclnnAiInfraFusedInferAttentionSinkMetadataV2,
...
__attribute__((visibility("default"))) aclnnStatus aclnnAiInfraFusedInferAttentionSinkMetadataV2(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
    aclrtStream stream)
{
  L2_DFX_PHASE_2(aclnnAiInfraFusedInferAttentionSinkMetadataV2);
